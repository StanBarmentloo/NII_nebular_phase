...
c = 299792.458 #km/s
M_sun = 1.989*10**33 #g
escatt_data_loc = '/home/stba7609/NII_nebular_phase/prerequisites/escatt_data/'
...
def fit_scipy_eg(wl, flux, p0, lower_bounds, upper_bounds, rounded_tau, noise_level):
    ...
    popt, pcov, infodict, mesg, ier = curve_fit(escatt_plus_gaussian_local, wl, flux*10**15, p0 = p0, bounds = (lower_bounds, upper_bounds), full_output = True, sigma = np.array([noise_level*10**15]*len(flux)), absolute_sigma = True)
...
def fit_scipy_eth(wl, flux, p0, lower_bounds, upper_bounds, rounded_tau, noise_level):
    ...
    popt, pcov, infodict, mesg, ier = curve_fit(escatt_plus_tophat_local, wl, flux*10**15, p0 = p0, bounds = (lower_bounds, upper_bounds), full_output = True, xtol = 1e-3, sigma = np.array([noise_level*10**15]*len(flux)), absolute_sigma = True)
